...
import { FaDollarSign, FaMapMarkerAlt, FaTags } from "react-icons/fa";
    ...
    <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {featured.map((property) => (
          <div
            key={property._id}
            className="bg-white dark:bg-gray-900 rounded-xl shadow-md dark:shadow-lg overflow-hidden flex flex-col hover:scale-105 transition-transform"
          >
            {/* Image */}
